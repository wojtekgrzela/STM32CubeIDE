...
typedef enum
{
	...
	/** SD Card errors **/
	SDCARD__INIT_FAILED								= 9001,
	SDCARD__UNMOUNTING_FAILED						= 9002,
	SDCARD__MOUNTING_FAILED							= 9003,
	SDCARD__WRITING_FAILED							= 9004,
	SDCARD__FILE_OPEN_FAILED						= 9005,
	SDCARD__FILE_CLOSE_FAILED						= 9006,
